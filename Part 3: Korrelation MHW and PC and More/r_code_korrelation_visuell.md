...
![](figures/PC_Summer_MHW_500dpi.png) \# 5. Correlation: MHW duration
and bloom intensity The goal is to test whether the intensity of
cyanobacterial blooms increases with the duration of marine heatwave
...
![](figures/MHW_vs_AlgalIntensity.png) \# 6. Generate figure for
Presentation and Understanding
